...
):UseCase<GetMovieListDataModel>() {
    override suspend fun executeOnBackground(): GetMovieListDataModel {
        return api.call().getMovieList(params as HashMap<String, String>)
    }
}